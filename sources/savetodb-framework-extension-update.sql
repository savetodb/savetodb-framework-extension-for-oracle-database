...
USING
    ...
    UNION ALL SELECT 'XLS', 'SAVETODB_FRAMEWORK_EXTENSION', 'VERSION', 'Information', NULL, NULL, 'ATTRIBUTE', '10.8', NULL, NULL, NULL FROM DUAL
...
prompt SaveToDB Framework Extension updated
